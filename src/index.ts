// @family-archive/ui — design-system component library.
// Styles ship separately as CSS (src/styles/*.css); components are class-based.
...
export type { ChipProps, ChipDot } from "./components/Chip";
